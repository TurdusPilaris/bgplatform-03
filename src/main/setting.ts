...
export const SETTING = {
    ...
    CUSTOM_RATE_LIMIT_COLLECTION_NAME:process.env.CUSTOM_RATE_LIMIT_COLLECTION_NAME|| '',
    DEVICE_AUTH_SESSION_COLLECTION_NAME:process.env.DEVICE_AUTH_SESSION_COLLECTION_NAME|| '',
    PATH_BLOGS:'/blogs',
    PATH_POSTS:'/posts',
    PATH_USERS:'/users',
    PATH_AUTH:'/auth',
